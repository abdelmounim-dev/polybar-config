...
if [[ $LAUNCHED != "" ]]; then
	...
	PLAY_PAUSE="%{A1:exec qdbus org.mpris.MediaPlayer2.clementine /org/mpris/MediaPlayer2 org.mpris.MediaPlayer2.Player.PlayPause:}⏯︎%{A}"
	PREVIOUS="%{A1:exec qdbus org.mpris.MediaPlayer2.clementine /org/mpris/MediaPlayer2 org.mpris.MediaPlayer2.Player.Previous:}⏮︎%{A}"
	NEXT="%{A1:exec qdbus org.mpris.MediaPlayer2.clementine /org/mpris/MediaPlayer2 org.mpris.MediaPlayer2.Player.Next:}⏭︎%{A}"
